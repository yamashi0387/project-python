...
url = "https://bgwflccuhngevggbpusm.supabase.co" #プロジェクトのURL
key = "sb_publishable_-JHKkmLzbmk8lS4tOqHh1w_qi00in8J" #DBに接続するためのキー
...
if 'total_score' not in st.session_state: #記憶させたいことを用意できるのがsession_state.
    ...
    st.session_state.turn = 0 #1ゲーム13ターンなのでターンも毎回1ターン目にされたら困る.
